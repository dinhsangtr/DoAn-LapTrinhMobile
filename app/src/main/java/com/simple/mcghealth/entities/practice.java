...
public class practice {
    ...
    public static List<practice> lisTTD (){
        ...
        practices.add(new practice(1,"Nhảy dây","Nhảy dây là bài tập đơn giản nhất giúp bạn đốt cháy nhiều calo, săn chắc cơ bắp và đồng thời giảm căng thẳng, mệt mỏi hiệu quả. Ba bài tập nhảy dây cá nhân phổ biến nhất là nhảy hai chân, nhảy dây chạy bộ và nhảy từng chân, mỗi bài tập đem đến những hiệu quả riêng."));
        practices.add(new practice(1, "Yoga","Yoga là tập hợp các phương pháp luyện tâm và luyện thân cổ xưa bắt nguồn từ đất nước Ấn Độ, đòi hỏi sự kết hợp cao độ của tinh thần và cơ thể trong cùng một thời điểm. Yoga có thể giúp bạn giảm cân nhanh và lành mạnh; giữ gìn sắc đẹp, đặc biệt là với phái nữ; đẩy lùi bệnh tật; cũng như sự thư thái, tĩnh tâm quý báu. Thời điểm hiện tại, việc đến các lớp học yoga gần như là không thể nên bạn chỉ có thể tham khảo các tài liệu, video trên mạng để tập theo những bài cơ bản và đơn giản nhất."));
        return practices;
    }
}
